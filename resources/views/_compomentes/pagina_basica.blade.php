...
<body style="background-color: darkgrey;">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="imagens/66126101_2451916695030144_8131608908037881856_n.jpg" class="d-block w-100 " alt="..." style="height: 750px;">
          <div class="carousel-caption d-none d-md-block div1" >
            <nav class="navbar navbar-expand-lg navbar-light bg-light menu1">
              <div class="container-fluid">
                <a class="navbar-brand" href="#"><img src="imagens/logo-leisure.png" alt="" class="logo"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                      <a class="nav-link active" aria-current="page" href="#"><img src="imagens/home.png" alt="" class="home"></a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="https://www.lojaeliana.com.br/mtz.php">MATOZINHOS</a></li>
                  ...
                  <form class="d-flex">
                    ...
                    <input class="form-control me-2" type="search" placeholder="Busca" aria-label="Search" style="
                          height: 38px;
                          width: 208px;">
                  </form>
                </div>
        ...
        <ul class="div2 list-unstyled">
          <!-- quarto -->
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle black" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              QUARTO
            </a>
            <ul class="dropdown-menu menu " aria-labelledby="navbarDropdown" style="background-image: url(imagens/quadros.jpg);">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu menu textmenu" aria-labelledby="navbarDropdown" style= "background-image: url(imagens/sala.jpg);">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu menu textmenu" aria-labelledby="navbarDropdown" style="background-image: url(imagens/cozinhajpg.jpg);">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu menu textmenu" aria-labelledby="navbarDropdown" style="background-image: url(imagens/linha\ infanti.jpg);">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu menu textmenu" aria-labelledby="navbarDropdown" style="background-image: url(imagens/eletrodomésticos.jpg);">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu menu textmenu" aria-labelledby="navbarDropdown" style="background-image: url(imagens/briquedos.jpg);">
      ...
      <p class="texto-de-baixo-menu">A Loja Eliana Móveis e Eletro é uma empresa familiar já tradicional em Matozinhos e Pedro Leopoldo com 40 anos no mercado de móveis, eletro e artigos para presentes. Com um serviço de qualidade e atendimento diferenciado que começa dentro da loja até a entrega do produto, a Loja Eliana tornou-se referência de bom gosto e de compromisso.</p>
...
<div  class="flex-container" style="margin: 5%;">
    ...
    <div>
      <div style="flex-basis: 550px;" class="fb-page fb_iframe_widget" data-href="https://www.facebook.com/elianaloja" data-tabs="" data-width="450" data-height="450" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true" fb-xfbml-state="rendered" fb-iframe-plugin-query="adapt_container_width=true&amp;app_id=&amp;container_width=74&amp;height=450&amp;hide_cover=false&amp;href=https%3A%2F%2Fwww.facebook.com%2Felianaloja&amp;locale=pt_BR&amp;sdk=joey&amp;show_facepile=true&amp;small_header=false&amp;tabs=&amp;width=450"><span style="vertical-align: bottom; width: 451px; height: 130px;"><iframe name="f22ed144e208c" width="450px" height="450px" data-testid="fb:page Facebook Social Plugin" title="fb:page Facebook Social Plugin" frameborder="0" allowtransparency="true" allowfullscreen="true" scrolling="no" allow="encrypted-media" src="https://www.facebook.com/v9.0/plugins/page.php?adapt_container_width=true&amp;app_id=&amp;channel=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df1981b0949b5b7c%26domain%3D%26origin%3Dfile%253A%252F%252F%252Ff138448c224dec4%26relation%3Dparent.parent&amp;container_width=74&amp;height=450&amp;hide_cover=false&amp;href=https%3A%2F%2Fwww.facebook.com%2Felianaloja&amp;locale=pt_BR&amp;sdk=joey&amp;show_facepile=true&amp;small_header=false&amp;tabs=&amp;width=450" style="border: none; visibility: visible; width: 451px; height: 130px;" class=""></iframe></span></div>
    </div>
  </div>

  <div id="fb-root"></div>
  <script async defer crossorigin="anonymous" src="https://connect.facebook.net/pt_BR/sdk.js#xfbml=1&version=v9.0" nonce="0YujvASa"></script>
